...
public class PausedMovement1 : MonoBehaviour
{
    ...
    private void Movement(bool incomingBool)
    {
        ...
        if (index == 2) // we need to create one additional pause to be in sync with the other moving platforms.
            index++;

        if (index == 4) // we need to create one additional pause to be in sync with the other moving platforms.
            index++;
    }
